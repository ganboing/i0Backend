...
mkdir "$llvm_dir/llvm.Cpu0.build"
llvm_build_dir=$(realpath "$llvm_dir/llvm.Cpu0.build")
echo "build to $llvm_build_dir"
mkdir "$llvm_dir/llvm.Cpu0.install"
llvm_install_dir=$(realpath "$llvm_dir/llvm.Cpu0.install")
